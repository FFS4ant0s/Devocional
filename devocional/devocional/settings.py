"""
Django settings for devocional project.
...
SECRET_KEY = 'django-insecure-i=dhocat7fob(@r!)od0%@b+_53y4q*b-l-=&1+@6b=l@-bs%5'
...
WSGI_APPLICATION = 'devocional.wsgi.application'
